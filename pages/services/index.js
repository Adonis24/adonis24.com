...
const starter = "https://res.cloudinary.com/ddgn7lxr9/image/upload/v1680598760/web-services-banner_sob2do.png";//"https://res.cloudinary.com/ddgn7lxr9/image/upload/v1679468035/images/trracntq5ewhyekojbqu.jpg"
 ...
 const  goToWebService = ()=>{
  
    router.push("./services/webService" , undefined, {
      shallow: false,
    })
  }
  const  goToMobileApp = ()=>{
  
    router.push("./services/mobileApp" , undefined, {
      shallow: false,
    })
  }
  const  goToIntegration1C = ()=>{
  
    router.push("./services/integration1C" , undefined, {
      shallow: false,
    })
  }
          ...
          <div className="row">
            <div className="col-sm-4">
              <div className="pricing-box">
                ...
                <button onClick={goToWebService} className="btn btn-outline-primary tw-p-4">Подробнее</button>
              </div>
            </div>
            <div className="col-sm-4">
              <div className="pricing-box selected">
                ...
                <button onClick={goToMobileApp} className="btn btn-primary">Подробнее</button>
              </div>
            </div>
            <div className="col-sm-4">
              <div className="pricing-box">
                ...
                <button onClick={goToIntegration1C}  className="btn btn-outline-primary">Подробнее</button>
              </div>
            </div>
          </div>
        </Fade>
