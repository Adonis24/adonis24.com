        ...
        <>
            <div className="card-form d-flex justify-content-center">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <label htmlFor="Name" className="form-label"><FaUserCircle /> Name</label>
                        <input type="text" className="form-control" id="name" required />
                    </div>
                    <div className="mb-3">
                        <label for="email" className="form-label"><MdEmail /> Email address</label>
                    ...
                    <div className="mb-3">
                        <label for="cpassword" className="form-label"><RiLockPasswordFill /> Confirm Password</label>
                        <input type="password" className="form-control" id="cpassword" required />
                    </div>
                    <div className="mb-3">
                        <p>Already registered ? <Link href="/login">Login</Link></p>
                    </div>
                    <button type="submit" className="btn btn-primary w-100 mb-3">{loading ? <div class="spinner-border" role="status" style={{ width: '1.5rem', height: '1.5rem' }}>
